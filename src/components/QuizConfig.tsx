  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          <label htmlFor="answers-per-question" className="block text-sm font-medium text-gray-700 mb-2">
            Antworten pro Frage
          </label>
          <input
            type="number"
        ...
        <div className="flex gap-4">
          <label className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <span>Nur Einzelauswahl (Single Choice)</span>
          </label>
          <label className="flex items-center">
            <input
              type="radio"
              ...
              className="mr-2"
            />
            <span>Mehrfachauswahl möglich (Multiple Choice)</span>
          </label>
        </div>
      </div>
