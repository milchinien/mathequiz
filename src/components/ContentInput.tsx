    ...
    <div className="space-y-4">
            ...
            >
              {fileName ? (
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-2">Klicken Sie, um eine andere Datei auszuwählen</p>
                </div>
              ) : (
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900">Datei hochladen</p>
                  <p className="text-sm text-gray-600 mt-2">PDF, TXT oder Markdown (max. 10MB)</p>
                </div>
              )}
            </label>
          </div>
      ...
      {mode === 'url' && (
        <div className="space-y-4">
          ...
          {content && mode === 'url' && (
            <div>
              <p className="text-sm text-gray-600 mb-2">Vorschau des abgerufenen Inhalts:</p>
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 max-h-48 overflow-y-auto">
                <p className="text-sm text-gray-700 whitespace-pre-wrap">{content.substring(0, 500)}...</p>
              </div>
            </div>
          )}
        </div>
